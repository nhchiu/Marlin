...
//
  ...
  //
    ...
    #define X_SERIAL_TX_PIN  3  //40
  #endif
  #ifndef X_SERIAL_RX_PIN
    #define X_SERIAL_RX_PIN  50  //63
  #endif
    ...
    #define Y_SERIAL_TX_PIN  21  //59
  #endif
  #ifndef Y_SERIAL_RX_PIN
    #define Y_SERIAL_RX_PIN  51  //64
  #endif
    ...
    #define Z_SERIAL_TX_PIN  20  //42
  #endif
  #ifndef Z_SERIAL_RX_PIN
    #define Z_SERIAL_RX_PIN  52  //65
  #endif
