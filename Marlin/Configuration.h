...
#define DELTA
  ...
  #define DELTA_HEIGHT 276.27 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { +0.00, -1.11, -1.77 } // get these from auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { +0.05, -0.02, -0.02 } // get these values from auto calibrate
...
#define Y_PROBE_OFFSET_FROM_EXTRUDER 0     // Y offset: -front +behind [the nozzle]
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -23.10     // Z offset: -below +above  [the nozzle]
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 5), 0, 20 }
