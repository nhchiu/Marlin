...
#define DELTA
  ...
  #define DELTA_HEIGHT 294.76 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, -0.09, -1.21 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 133.74 //mm  Get this value from auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { 0.00, 0.02, -0.02 } // get these values from auto calibrate
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 80, 97.4 }  // default steps per unit for Kossel (GT2, 20 tooth)
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -14.8  // Z offset: -below +above  [the nozzle]
