...
#define LCD_FEEDBACK_FREQUENCY_HZ 000
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIN    6        // LED driving pin on motherboard 4 => D4 (EXP2-5 on Printrboard) / 30 => PC7 (EXP3-13 on Rumba)
