...
#define DELTA
  ...
  #define DELTA_HEIGHT 283.15             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { -0.30, 0.00, -1.17 } // Get these values from G33 auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { -0.08, +0.25, -0.17 } // Get these values from G33 auto calibrate
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 120, 120, 120, 100}
...
#define Y_PROBE_OFFSET_FROM_EXTRUDER 0     // Y offset: -front +behind [the nozzle]
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -21.4  // Z offset: -below +above  [the nozzle]
...
//#define Z_AFTER_PROBING            (Z_CLEARANCE_DEPLOY_PROBE + 5) // Z position after probing is done
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 3), 0, 20 }
